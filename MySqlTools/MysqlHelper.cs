...
namespace MySqlTools
{
    ...
    {
        public static string ConnStr="Database=ele;Data Source=127.0.0.1;"+
                "User Id=root;Password= ;pooling=false;CharSet=utf8;port=3306";
        ...
        public static MySqlDataReader Get_Reader(string SQL, string ConnStr)
        {
           ...
           // Close_Conn(Conn);不能关闭连接，必须由reader关闭连接
            return Dr;
        }
